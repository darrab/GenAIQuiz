...
class QuizApp:
    ...
    def get_lecture_selection(self):
        ...
        print("7. All Lectures (Full 300 Questions)")
        ...
        while True:
            ...
            if choice == '7':
                ...
                return [q for q in self.all_questions if q['lec'] == lecture_id]
            else:
    ...
    def run_quiz(self, questions):
        ...
        for i, q in enumerate(questions, 1):
            print(f"\n--- Question {i}/{total_questions} (Lecture {q['lec']}) ---")
            print(f"Q: {q['q']}")
            for opt in q['opts']:
                print(f"  {opt}")
...
def main():
    ...
    print("Based on 6 Lectures (300 Questions)")
